...
export const curriculumData = {
    ...
    9: {
      ...
      "Kimya": ["Kimya Bilimi", "Atom ve Periyodik Sistem", "Kimyasal Türler Arası Etkileşimler", "Maddenin Hâlleri", "Doğa ve Kimya"],
      "Biyoloji": ["Yaşam Bilimi Biyoloji", "Canlıların Temel Bileşenleri", "Hücre", "Canlıların Çeşitliliği ve Sınıflandırması"],
      "Edebiyat": ["Edebiyata Giriş", "Hikâye", "Şiir", "Masal / Fabl", "Roman", "Tiyatro", "Biyografi / Otobiyografi"],
      ...
      "Coğrafya": ["Doğa ve İnsan", "Dünya'nın Şekli ve Hareketleri", "Yer ve Zaman", "Harita Bilgisi", "İklim Bilgisi"]
    },
    10: {
       ...
       "Kimya": ["Kimyanın Temel Kanunları", "Kimyasal Tepkimelerde Hesaplamalar", "Karışımlar", "Asitler, Bazlar ve Tuzlar", "Kimya Her Yerde"],
       "Biyoloji": ["Hücre Bölünmeleri", "Kalıtım", "Ekosistem Ekolojisi", "Güncel Çevre Sorunları"],
       "Edebiyat": ["Edebiyat Tarihi", "Halk Edebiyatı (Destan, Efsane, Koşuk)", "Divan Edebiyatı (Kasîde, Gazel)", "Roman", "Tiyatro"],
       "Tarih": ["Yerleşme ve Devletleşme Sürecinde Selçuklu", "Beylikten Devlete Osmanlı", "Devletleşme Sürecinde Savaşçılar", "Dünya Gücü Osmanlı"],
       "Coğrafya": ["Yerin Yapısı ve Oluşum Süreci", "Su, Toprak ve Bitki", "Nüfus", "Göç", "Ekonomik Faaliyetler"]
    },
    11: {
       ...
       "Fizik": ["Kuvvet ve Hareket (Atışlar, İtme-Momentum)", "Tork ve Denge", "Elektrik ve Manyetizma (Elektrik Alan, Potansiyel)", "Alternatif Akım"],
       "Kimya": ["Modern Atom Teorisi", "Gazlar", "Sıvı Çözeltiler", "Kimyasal Tepkimelerde Enerji", "Tepkime Hızları ve Denge"],
       "Biyoloji": ["İnsan Fizyolojisi (Denetleyici ve Düzenleyici Sistemler)", "Destek Hareket, Sindirim, Dolaşım", "Solunum ve Boşaltım", "Komünite ve Popülasyon Ekolojisi"],
       "Edebiyat": ["Öğretici Metinler", "Servetifünun ve Türk Dünyası Edebiyatı", "Tanzimat Dönemi Hikâye ve Romanı", "Cumhuriyet Dönemi Romanı"],
       "Tarih": ["Değişen Dünya Dengeleri Karşısında Osmanlı", "Değişim Çağında Avrupa ve Osmanlı", "Uluslararası İlişkiler"],
       "Coğrafya": ["Ekosistemlerin Özellikleri", "Şehirlerin Fonksiyonları", "Üretim Dağıtım Tüketim", "Türkiye'nin Doğal Kaynakları ve Ekonomisi"]
    },
    12: {
       "Matematik": ["Üstel ve Logaritmik Fonksiyonlar", "Diziler", "Trigonometri", "Limit ve Süreklilik", "Türev", "İntegral", "Çemberin Analitik İncelenmesi"],
       "Fizik": ["Düzgün Çembersel Hareket", "Basit Harmonik Hareket", "Dalga Mekaniği", "Atom Fiziğine Giriş", "Radyoaktivite", "Modern Fizik"],
       "Kimya": ["Kimya ve Elektrik (Elektrokimya)", "Karbon Kimyasına Giriş", "Organik Bileşikler", "Enerji Kaynakları", "Bilimsel Gelişmeler"],
       "Biyoloji": ["Genden Proteine (Nükleik Asitler, Replikasyon, Translasyon)", "Canlılarda Enerji Dönüşümleri (Fotosentez, Solunum)", "Bitki Biyolojisi", "Canlılar ve Çevre"],
       "Edebiyat": ["1960 Sonrası Cumhuriyet Edebiyatı", "Cumhuriyet Dönemi Şiir ve Roman", "Deneme ve Söylev (Nutuk)", "Dünya Edebiyatı"],
       "T.C. İnkılap Tarihi ve Atatürkçülük": ["20. Yüzyıl Başlarında Osmanlı", "Milli Mücadele Dönemi", "Atatürk İlke ve İnkılapları", "Atatürk Dönemi Dış Politika", "Demokratikleşme Çabaları"],
       "Coğrafya": ["Ekstrem Doğa Olayları", "Küresel İklim Değişimi", "Ülkelerin Gelişmişlik Seviyeleri", "Küresel Ortam ve Çevre Sorunları"]
    }
  };
